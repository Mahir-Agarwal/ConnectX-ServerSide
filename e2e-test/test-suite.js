...
async function runTest() {
    ...
    try {
        ...
        log("1️⃣  Creating Session via Gateway...", colors.yellow);
        ...
        log("\n2️⃣  Connecting SENDER to Signaling Service...", colors.yellow);
        ...
        log("\n3️⃣  Connecting RECEIVER to Signaling Service...", colors.yellow);
        ...
        log("\n4️⃣  Verifying Join Handshake...", colors.yellow);
        ...
        log("\n5️⃣  Testing Signaling Exchange...", colors.yellow);
        ...
        log("\n6️⃣  Testing ICE Candidate Exchange...", colors.yellow);
